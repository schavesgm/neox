...
_G.neox.set_keymap("n", "<C-1>", function() harpoon:list():select(1) end)
_G.neox.set_keymap("n", "<C-2>", function() harpoon:list():select(2) end)
_G.neox.set_keymap("n", "<C-3>", function() harpoon:list():select(3) end)
_G.neox.set_keymap("n", "<C-4>", function() harpoon:list():select(4) end)
